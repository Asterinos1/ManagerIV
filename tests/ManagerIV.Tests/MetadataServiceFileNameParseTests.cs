...
public class MetadataServiceFileNameParseTests
{
    ...
    [InlineData("GCU_Car_Pack_v1.2.2_manual-371-1-2-2-1701171631.rar", "GCU Car Pack", "1.2.2", "manual")]
    [InlineData("Realistic Handling and Physics v1.1-195-1-1-1671355668.zip", "Realistic Handling and Physics", "1.1", "")]
    [InlineData("GTA IV DXVK 2.8.1 Stable-188-2-8-1-Stable-1772181141.zip", "GTA IV DXVK", "2.8.1", "Stable")]
    [InlineData("Rivers of Blood v 8.1 HD Fusion Fix-263-9-1-1772330775.rar", "Rivers of Blood", "8.1", "HD")]
    ...
    [InlineData("1738616364_Liberty Alive V2 - BUSTED.rar", "Liberty Alive", "2", "BUSTED")]
